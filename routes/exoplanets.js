...
router.post('/add', upload.single('imageExoplanet'), function (req, res, next) {
    ...
    if (validator.isLength(req.body.uniqueNameExoplanet, { min: 3, max: 100 })) {
        ...
        manageAddExoplanet(req, filename, res);
    }
    else {
...
router.get('/search', function (req, res, next) {
    manageSearchExoplanet(req, res);
});

router.post('/delete', (req, res, next) => {
    manageDeleteExoplanet(req, res);
});
...
router.get('/details', function (req, res, next) {
    manageDetailsExoplanet(req, res);

});


router.get('/filter', function (req, res, next) {
    manageFilterExoplanet(req, res);
});
...
router.post('/update', function (req, res, next) {
    manageUpdateExoplanet(req, res);
});


module.exports = router;
function manageAddExoplanet(req, filename, res) {
    Exoplanet.save({
...
function manageSearchExoplanet(req, res) {
...
function manageDeleteExoplanet(req, res) {
    console.log("id Exoplanète à supprimer : " + req.body.id);
    Exoplanet.delete(req.body.id);
    res.redirect('/exoplanets');
}

function manageDetailsExoplanet(req, res) {
...
function manageFilterExoplanet(req, res) {
...
function manageUpdateExoplanet(req, res) {
